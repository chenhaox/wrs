...
U_PICK_POSE = (BOX1_CENTER + np.array([0.2, 0.1, 0.0]), OBJECT_UP_DOWN_ROTMAT)
U625_PICK_POSE = (BOX2_CENTER + np.array([0.1, 0.0, 0.0]), np.eye(3))
...
UR3_DUAL_LFT_HOME_CONF = np.array([np.pi / 12.0,
                                   -np.pi / 3.0,
                                   -2.0 * np.pi / 3.0,
                                   -np.pi,
                                   -2.0 * np.pi / 3.0,
                                   0.0])
UR3_DUAL_RGT_HOME_CONF = np.array([-np.pi / 12.0,
                                   -2.0 * np.pi / 3.0,
                                   2.0 * np.pi / 3.0,
                                   0.0,
                                   2.0 * np.pi / 3.0,
