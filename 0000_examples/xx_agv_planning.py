...
object_box5 = object_box.copy()
object_box5.set_pos(np.array([2.9, -1, 0]))
object_box5.attach_to(base)

object_box6 = object_box.copy()
object_box6.set_pos(np.array([2.9, -.5, 0]))
object_box6.attach_to(base)

object_box7 = object_box.copy()
object_box7.set_pos(np.array([2.9, -2, 0]))
object_box7.attach_to(base)

object_box8 = object_box.copy()
object_box8.set_pos(np.array([2.9, -1.5, 0]))
object_box8.attach_to(base)
...
path = rrtc_planner.plan(start_conf=np.array([1, 0, 0]),
