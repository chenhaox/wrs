...
if __name__ == '__main__':
    ...
    from regrasp.utils.visualize import visualize_grasps_fp
    ...
    hmstr = Handover(obj_cm=obj_cm,
                     ...
                     rbt=rbt)
    fp_list = hmstr._gen_fp_list([np.array([0.700, 0, 1.300])], toggle_debug=False)
    hmstr._gen_grasp_list_fp(fp_list)
    visualize_grasps_fp(hmstr.grasp_list_fp_rgt, fp_list,
                        obj_cm, gripper_s, base,)
    base.run()
