param(
    ...
    [string]$OutputPrefix = "global_accel_general_v31",
    [string]$WarmLayout = "",
    [int]$Explore = 80,
    [int]$MaxEvals = 220,
...
$LOG = "$LOGDIR\global_accel_general_v31.log"

New-Item -ItemType Directory -Force $LOGDIR | Out-Null
New-Item -ItemType Directory -Force $OUT | Out-Null

Write-Host "============================================================"
Write-Host "General Global Accelerated Search V3.1"
...
Write-Host "Max evals      : $MaxEvals (strict upper bound)"
Write-Host "Checkpoint     : $CHECKPOINT"
Write-Host "Log            : $LOG"
Write-Host "============================================================"

$Args = @(
    "-m", "sealp.examples.layout.find_optimal_initial_layout_tower_global_accel_general_v31",
    "--asmdef", $Asmdef,
    "--config", $Config,
    "--grasp-dir", $GraspDir,
    "--output-dir", $OUT,
