#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""General deterministic accelerated Global-to-Local layout search V3.2.
...
import uniform_grasp_accel_v32 as uniform_accel
...
def main() -> None:
    ...
    print("[global-accel-v3.2] config:")
    for key, value in ACFG.items():
        print(f"    {key:30s} = {value}")
    print("[global-accel-v3.2] original Global file remains untouched")
    print(
        "[global-accel-v3.2] rotation handling: Halton prioritizes "
    ...
    try:
        ...
        print(
            f"[global-accel-v3.2] wall-clock total = "
