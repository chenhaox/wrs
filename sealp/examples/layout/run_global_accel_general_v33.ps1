param(
    ...
    [ValidateSet("same_grasp_progressive", "same_grasp_full", "legacy_fast")]
...
$LOG = "$LOGDIR\global_accel_general_v33.log"

New-Item -ItemType Directory -Force $LOGDIR | Out-Null
New-Item -ItemType Directory -Force $OUT | Out-Null

$Args = @(
    "-m", "sealp.examples.layout.find_optimal_initial_layout_tower_global_accel_general_v33",
    "--asmdef", $Asmdef,
    "--config", $Config,
    "--grasp-dir", $GraspDir,
    "--output-dir", $OUT,
...
Write-Host "============================================================"
Write-Host "General Global Accelerated Search V3.3"
