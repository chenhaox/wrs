#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""General deterministic accelerated Global-to-Local layout search V3.
...
import uniform_grasp_accel_v3 as uniform_accel
...
def main() -> None:
    ...
    print("[global-accel-v3] config:")
    for key, value in ACFG.items():
        print(f"    {key:30s} = {value}")
    print("[global-accel-v3] original Global file remains untouched")
    print(
        "[global-accel-v3] rotation handling: Halton prioritizes "
    ...
    try:
        ...
        print(
            f"[global-accel-v3] wall-clock total = "
